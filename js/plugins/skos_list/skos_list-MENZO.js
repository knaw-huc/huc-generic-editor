...
function append_letter_frame() {
    var url = window.location.protocol + '//' + window.location.host + skosListRegistry.skosURI + '/index';
    console.log(url);
    return $.ajax(
    {
        type: "GET",
...
function create_skos_link() {
    ...
    $(obj).on("click", function () {
        window.open(window.location.protocol + '//' + window.location.host + skosListRegistry.skosURI + '/home',"home");
    })
    $(obj).html('Skosmos');
    return obj;
}
